...
--聊天命令
game_cmd.SUB_GF_USER_CHAT			= 200--10									--用户聊天
game_cmd.SUB_GF_USER_EXPRESSION		= 21									--用户表情
game_cmd.SUB_GF_USER_VOICE 			= 12 									--用户语音

--系统消息
game_cmd.SUB_GF_SYSTEM_MESSAGE		= 202 --200									--系统消息
