...
function SelectNode:initTypeSelect()
  ...
  for i=1, self._mobilePutCard.cbMobilePutCount do
    ...
    -- else
      if middletype == GameLogic.CT_FIVE_STRAIGHT_FLUSH then
    ...
    -- else
      if tailtype == GameLogic.CT_FIVE_STRAIGHT_FLUSH then
...
--选牌结束
function SelectNode:selectCardFinish(isOverTime)
  --我简直就是天才
