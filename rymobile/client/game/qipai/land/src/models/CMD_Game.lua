...
cmd.CMD_S_StatusFree = 
{
    ...
    --当前红包 如果大于当前局数bossCount 可拆。 如果小于 这个就是当前局数，显示 3-局数
    {k = "szHongbao", t = "byte", l = {cmd.PLAYER_COUNT}},      --
    {k = "szTargetnumber", t = "word"},
}
...
cmd.CMD_S_StatusCall = 
{
    ...
    {k = "cbUserTrustee", t = "byte", l = {cmd.PLAYER_COUNT}}, --托管标志
    --历史积分
    {k = "lTurnScore", t = "score", l = {cmd.PLAYER_COUNT}},    --积分信息
    {k = "lCollectScore", t = "score", l = {cmd.PLAYER_COUNT}}, --积分信息
    {k = "szHongbao", t = "byte", l = {cmd.PLAYER_COUNT}},  
