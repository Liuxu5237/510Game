...
function BankLayer:ctor(parentNode)
    ...
    self.bg = cc.Sprite:create("im_help.png")
    self.bg:setPosition(cc.p(667,375))
    self.bg:addTo(self)
    
    ccui.Button:create("btn_close.png","btn_close.png")
    :move(588,391 )
    :addTo(self.bg)
    :addClickEventListener(function()     dismissPopupLayer(self)
    end)
