...
cmd.SUB_C_SCENE_START = 1 --开始游戏
cmd.SUB_C_GUESS_CARD = 2 --开始猜牌
cmd.SUB_C_STEP_OVER=3 --阶段结束

cmd.SUB_C_ENTER_GAMBLE = 10 --进入小游戏
cmd.SUB_C_GUESS_CARD_AUTO_LEAVE = 13 --离开小游戏 
cmd.SUB_C_ENTER_SHELL = 14 --进入贝壳
cmd.SUB_C_GAMBLE_SHELL=15 --获取贝壳

cmd.SUB_C_BONUS_ENTER=16 --请求爬树游戏
cmd.SUB_C_BONUS_EXIT=17 --爬树游戏结束
