...
--龙虎索引
cmd.AREA_LOONG                  = 0     --龙索引
cmd.AREA_TIGER                  = 1     --虎索引
cmd.AREA_EQUAL                  = 2     --和索引
...
--是否管理
cmd.SUB_S_ADMIN_USER			 = 120									--是否管理员
...
cmd.SUB_C_CONTORLSCORE			=150								


cmd.SUB_S_CONTORLSCORE			=151		
cmd.SUB_S_UserBetInfo	=152													

cmd.SUB__C_CFISH_ROOM           = 55
--回调数据
cmd.SUB_S_CFISH_ROOM            =56     

cmd.CMD_S_OllUserInfo=
{
    {k = "lStorageStart", t = "byte"},
};
...
--在线列表
cmd.CMD_S_OFFUSER_INFO = 
{
	{k = "cbColumnCount", t = "byte"},									--信息数量
	{k = "FishServerInfo", t = "table", d = cmd.tagOffUserInfo, l = {100}},
}
