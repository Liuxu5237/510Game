...
local GameViewLayer = appdf.req(appdf.GAME_SRC.."yule.oxbattle2.src.views.layer.GameViewLayer")
local GameFrame = appdf.req(appdf.GAME_SRC.."yule.oxbattle2.src.models.GameFrame")
...
function GameLayer:onUserChat(chat, wChairId)
    ...
    self._gameView:userChat(wChairId==self:GetMeChairID(),szNickName, chat.szChatString)
end
...
function GameLayer:onUserExpression(expression, wChairId)
    ...
    self._gameView:userExpression(szNickName, expression.wItemIndex)
end
