...
function UserItem:ctor()
	...
	--头像
	self.headbackground = HeadBackground:create()
...
function UserItem:refresh( useritem,var_bRob, yPer, showtype)
	...
	self.m_head = PopupInfoHead:createNormal(useritem, 71) 
	self.m_head:setPosition(0,0)
	self.headbackground:addChild(self.m_head)
