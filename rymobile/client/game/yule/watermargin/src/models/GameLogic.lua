...
function GameLogic:GetZhongJiangTime( cbIndex ,cbItemInfo )
	...
	for i=1,item_x_count do
		--左到右基本奖
		if cbItemInfo[ptXian[cbLeftFirstIndex].x][ptXian[cbLeftFirstIndex].y] == cbItemInfo[ptXian[i].x][ptXian[i].y] or cbItemInfo[ptXian[i].x][ptXian[i].y] == GameLogic.CT_SHUIHUZHUAN then
			if bLeftLink == true then
		...
		--右到左基本奖
		if cbItemInfo[ptXian[cbRightFirstIndex].x][ptXian[cbRightFirstIndex].y] == cbItemInfo[ptXian[item_x_count-i+1].x][ptXian[item_x_count-i+1].y] or cbItemInfo[ptXian[item_x_count-i+1].x][ptXian[item_x_count-i+1].y] == GameLogic.CT_SHUIHUZHUAN then
			if bRightLink == true then
