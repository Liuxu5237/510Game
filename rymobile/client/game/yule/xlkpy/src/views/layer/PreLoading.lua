...
function PreLoading.loadTextures()
    ...
    --gameShowToast(runScene, "捕鱼资源加载111111", 3)
    ...
    --gameShowToast(runScene, "捕鱼资源加载22222222", 3)
	loadImages()
    --gameShowToast(runScene, "捕鱼资源加载33333333", 3)
	--进度条
    --print("1---------------dyj3")
	...
	--PreLoading.addEvent()
    --gameShowToast(runScene, "捕鱼资源加载5555555555", 3)
end
...
function PreLoading.GameLoadingView()
    ...
    --gameShowToast(scene, "捕鱼资源加载66666666666666", 3)
    ...
    --gameShowToast(scene, "捕鱼资源加载888888888888", 3)
    ...
    PreLoading.loadingBar:setPosition(cc.p(layer:getContentSize().width/2,95))
    ...
    --gameShowToast(scene, "捕鱼资源加载99999999999999", 3)
end
...
--            local  frameShadow = display.newSprite(frameName)
--           :setPosition(cc.p(50,-50))
--            :addTo(frame)
--          --  frame:addChild(frameShadow)
	        table.insert(frames, frame)
--            animation.a
    	end
