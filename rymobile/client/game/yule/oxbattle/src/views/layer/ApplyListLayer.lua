...
function ApplyListLayer:refreshList( userlist )
	...
	if state == self.m_parent._apply_state.kCancelState then
		str1 = "game_res1/bt_apply_0_0.png"
		str2 = "game_res1/bt_apply_0_1.png"
		str3 = "game_res1/bt_apply_0_2.png"

		--申请条件限制
		ExternalFun.enableBtn(self.m_btnApply, self.m_parent:getApplyable())
	elseif state == self.m_parent._apply_state.kApplyState then
		str1 = "game_res1/bt_cancel_apply_0.png"
		str2 = "game_res1/bt_cancel_apply_1.png"
		str3 = "game_res1/bt_cancel_apply_2.png"

		ExternalFun.enableBtn(self.m_btnApply, true)
	elseif state == self.m_parent._apply_state.kApplyedState then
		str1 = "game_res1/bt_cancel_banker_0.png"
		str2 = "game_res1/bt_cancel_banker_1.png"
		str3 = "game_res1/bt_cancel_banker_2.png"
	...
	if nil ~= str1 and nil ~= str2 then
		btn:loadTextureDisabled(str3,0)
		btn:loadTextureNormal(str1,0)
		btn:loadTexturePressed(str2,0)
	end
	btn:setTag(state)
end
