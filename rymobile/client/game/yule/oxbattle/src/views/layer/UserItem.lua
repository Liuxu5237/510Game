...
function UserItem:ctor()
	...
	local goldicon = csbNode:getChildByName("sp_gold_5")
	goldicon:setTexture("plaza/game_gold.png")
...
function UserItem:refresh( useritem,var_bRob, yPer, showtype)
	...
	self.m_head:setPosition(-197,37)
	...
	self.m_head:enableInfoPop(false, showpos, anchor)
