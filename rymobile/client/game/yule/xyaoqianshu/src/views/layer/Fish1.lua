...
function Fish:initAnim1()
	...
	if self.m_data.fish_kind == Game_CMD.FishType_TuLongDao then
		self.m_scoreLabel:setPosition(cc.p(self:getContentSize().width/2,self:getContentSize().height/2))
	end
...
function Fish:initAnim()
    ...
    if self.m_data.fish_kind == Game_CMD.FishType_JuXingHuangJinSha or self.m_data.fish_kind == Game_CMD.FishType_JinLong or self.m_data.fish_kind == Game_CMD.FishType_TuLongDao or self.m_data.fish_kind == Game_CMD.FishType_JinQianNianGui then
   ...
   -- self.bomType=self.m_data.m_fudaifishtype
    ...
    if self.lockType == 2 or self.lockType == 3 then
