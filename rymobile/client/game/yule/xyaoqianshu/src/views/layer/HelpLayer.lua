...
print("========= 问题排查1")
    ...
    for i = 1, 24 do
        ...
        local FileNode = fish_bg:getChildByName("FileNode_" .. i)
        ...
        elseif i >= 3 and i <= 5 or i == 9 or i == 11 or i == 13 or i >= 15 and i <= 17 then
            action:gotoFrameAndPlay(0, 110, true)
        elseif i == 6 then
            action:gotoFrameAndPlay(0, 120, true)
        elseif i == 8 or i == 14 or i == 21 or i == 22 or i == 23 then
...
print("========= 问题排查4")
    ...
    for i = 31, 40 do
        ...
        action1:gotoFrameAndPlay(0, 360, true)
