...
function GameViewLayer:onExit()
    ...
    for k,v in pairs(oldPaths) do
        a = nil 
        a = string.match(tostring(v), "/xyaoqianshu/")
...
function GameViewLayer:addSerchPaths( )
   --搜索路径
    ...
    if device.platform == "windows" then
        cc.FileUtils:getInstance():addSearchPath("game/yule/xyaoqianshu/res/")
    end
...
function GameViewLayer:initView(  )
    ...
    local bg =  ccui.ImageView:create("background/game_bg_4.jpg")
...
--声音
    ...
    self.speed_effect:setScale(1.2)
...
--帮助
    ...
    self.help:setPosition(cc.p(160,370))
    self.help:setTag(2)
          ...
          for i = 1, #cannon.m_goldList do
            ...
            if node then
                 node:runAction(cc.Sequence:create(cc.MoveBy:create(0.35,cc.p(tMoveX,tMoveY)),  cc.CallFunc:create(function()
                    if cannon.moveAllBannerAndGolds then
