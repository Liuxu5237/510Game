...
local cmd  = {}
cmd.RES_PATH = "game/yule/xyaoqianshu/res/"
--游戏版本
...
--鱼索引
-- 正常鱼
cmd.FishType_XiaoHuangCiYu      = 1               -- 小黄刺鱼
cmd.FishType_XiaoCaoYu      = 2               -- 小草鱼
cmd.FishType_ReDaiHuangYu     = 3               -- 热带黄鱼
cmd.FishType_DaYanJinYu       = 4               -- 大眼金鱼
cmd.FishType_ReDaiZiYu      = 5               -- 热带紫鱼
cmd.FishType_XiaoChouYu       = 6               -- 小丑鱼
cmd.FishType_HeTun      = 7               -- 河豚
cmd.FishType_ShiTouYu       = 8               -- 狮头鱼
cmd.FishType_DengLongYu       = 9               -- 灯笼鱼
cmd.FishType_WuGui        = 10               -- 乌龟
cmd.FishType_ShengXianYu        = 11              -- 神仙鱼
cmd.FishType_HuDieYu        = 12              -- 蝴蝶鱼
cmd.FishType_LingDangYu       = 13              -- 铃铛鱼
cmd.FishType_JianYu         = 14              -- 剑鱼
cmd.FishType_MoGuiYu        = 15              -- 魔鬼鱼
cmd.FishType_DaBaiSha       = 16              -- 大白鲨
cmd.FishType_DaJinSha       = 17              -- 大金鲨


-- 特殊鱼
cmd.FishType_JuXingHuangJinSha        = 18    -- 金鲸
cmd.FishType_JinLong        = 19              -- 金龙
cmd.FishType_JinQianNianGui        = 20              -- 金色千年龟摇钱树
cmd.FishType_TuLongDao        = 21             -- 屠龙刀
cmd.FishType_YinQianNianGui        = 22              -- 银色千年龟定屏炸弹
cmd.FishType_LvQianNianGui        = 23              -- 绿色千年龟局部炸弹

cmd.FishType_PiaoLiuPing        = 24               -- 全屏炸弹
