...
local AdminLayer = appdf.req("game.yule.godofwealth.src.views.layer.AdminLayer")
...
--发送游戏开始
function GameLayer:startGame(line,bet,linecost)
...
function GameLayer:onEventGameMessage(sub,dataBuffer)
	...
	if sub == g_var(cmd).SUB_S_START_GAME then  
		...
		print("######win:"..win) 
		self._gameView:startRoll2(icon,win)
