...
login.CMD_GP_UserInsureInfo = 
{
    ...
    {k = "wPeoplecont", t = "byte"},                         --常用人数
    {k = "wPeopleone", t = "dword"},
    {k = "wPeopletwo", t = "dword"},
    {k = "wPeoplether", t = "dword"},
...
login.SUB_MB_LOGON_AIWAN					= 6							--天宇登陆
------
--发包结构
login.CMD_MB_LogonOtherPlatform = 
{
    ...
    {k = "szClientip", t = "tchar", s = 16},							--IP
    {k = "szChannelnumber", t = "word"},								--推广码
    {k = "szFaceAddress", t = "tchar", s = 256},						--头像地址
}

--爱玩月登录  --现在叫天宇游了
login.CMD_MB_LogonAiwanPlatform=
{
	{k = "wModuleID", t = "word"},										--模块标识
	{k = "dwPlazaVersion", t = "dword"},								--广场版本
	{k = "cbDeviceType", t = "byte"},									--设备类型
	...
	{k = "cbPlatformID", t = "byte"},									--平台编号
	{k = "szUserUin", t = "tchar", s = yl.LEN_USER_UIN},				--用户Uin

	{k = "szMachineID", t = "tchar", s = yl.LEN_MACHINE_ID},			--机器标识
	{k = "szPassword", t = "tchar", s = yl.LEN_PASSWORD},				--用户密码
	{k = "szAccounts", t = "tchar", s = yl.LEN_ACCOUNTS},				--登陆帐号
	{k = "szClientip", t = "tchar", s = 16},							--IP
    {k = "szChannelnumber", t = "word"},								--渠道码
    {k = "szVerification", t = "word"},								    --是否验证
