...
call  cocos luacompile -s ..\client\client -d ..\client\ciphercode\client -e -k ZK_RY_IHIHVIP_!2020 -b ZK_IHIH_QQ2020 --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\game -d ..\client\ciphercode\game -e -k ZK_RY_IHIHVIP_!2020 -b ZK_IHIH_QQ2020 --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\base -d ..\client\ciphercode\base -e -k ZK_RY_IHIHVIP_!2020 -b ZK_IHIH_QQ2020 --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\command -d ..\client\ciphercode\command -e -k ZK_RY_IHIHVIP_!2020 -b ZK_IHIH_QQ2020 --disable-compile
if  errorlevel 1 goto CipherSrcError
