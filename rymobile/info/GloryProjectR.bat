...
call  cocos luacompile -s ..\client\client -d ..\client\ciphercode\client -e -k c5l0qU0aIZRBLfI2pKf -b R3HkX82TtxvEK0 --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\game -d ..\client\ciphercode\game -e -k c5l0qU0aIZRBLfI2pKf -b R3HkX82TtxvEK0 --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\base -d ..\client\ciphercode\base -e -k c5l0qU0aIZRBLfI2pKf -b R3HkX82TtxvEK0 --disable-compile
if  errorlevel 1 goto CipherSrcError
if  errorlevel 0 goto ZipFile
call  cocos luacompile -s ..\client\command -d ..\client\ciphercode\command -e -k c5l0qU0aIZRBLfI2pKf -b R3HkX82TtxvEK0 --disable-compile
if  errorlevel 1 goto CipherSrcError
if  errorlevel 0 goto ZipFile
pause
exit
...
call  cocos compile -p android --ap android-20 -j 4
POPD
