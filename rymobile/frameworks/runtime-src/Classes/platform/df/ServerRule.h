...
#define SR_ALLOW_QUEUING			0x00008000							//排队游戏
//银行规则
...
public:
	...
	//排队游戏
	static bool IsQueuingGame(dword dwServerRule)
	{
		return 0 != (dwServerRule&SR_ALLOW_QUEUING);
	}
...
public:
	...
	//排队游戏
	static void SetQueuingGame(dword & dwServerRule, bool bEnable)
	{
		(bEnable == true) ? dwServerRule |= SR_ALLOW_QUEUING : dwServerRule &= ~SR_ALLOW_QUEUING;
	}
