...
//游戏参数
class CParameterGame : public cocos2d::Ref
{
	//友元定义
...
//房间参数
class CParameterServer : public cocos2d::Ref
{
	//配置变量
public:
...
public:
	//默认参数
	void DefaultParameter();
	char* GetParameterPassword(){ return m_szPassword; }
};
...
//全局参数
class CParameterGlobal : public cocos2d::Ref
{
	//静态函数
public:
	//获取对象
