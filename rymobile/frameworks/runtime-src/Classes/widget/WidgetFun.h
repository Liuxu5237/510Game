...
namespace WidgetFun
{
	...
	void setImagic(cocos2d::Node* pNode, std::string kImagic, int bSameSize ,bool Isplist = false);
	void setImagic(cocos2d::Node* pNode, std::string kName, std::string kImagic, bool bSameSize = true, bool Isplist= false);
