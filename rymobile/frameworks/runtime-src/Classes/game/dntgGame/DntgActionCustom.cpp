...
Action_Move_Point* Action_Move_Point::create(float d, Move_Points &points, const xPoint &offse)
{
	Action_Move_Point* act = new Action_Move_Point();
...
bool Action_Move_Point::init(float d, Move_Points &points, const xPoint &offset)
{
...
void Action_Move_Point::update(float time)
{
	...
	float angle = 360 - move_point.angle_;
...
xPoint Action_Move_Point::BirdMoveTo(float elapsed)
{
...
///////////////////////////////////////////////////////////////////////////
Action_Bullet_Move * Action_Bullet_Move::create(float angle, float speed)
{
	Action_Bullet_Move* act = new Action_Bullet_Move();
...
bool Action_Bullet_Move::init(float angle, float speed)
{
...
void Action_Bullet_Move::startWithTarget(Node *target)
{
...
////////////////////////////////////////////////////////////////////////////////////////////
Action_Bullet_Move_To * Action_Bullet_Move_To::create(const xPoint & start, const xPoint & end, float angle, float speed)
{
	Action_Bullet_Move_To* act = new Action_Bullet_Move_To();
...
bool Action_Bullet_Move_To::init(const xPoint & start, const xPoint & end, float angle, float speed)
{
	Action_Bullet_Move::init(angle, speed);
	angle_ = angle;
	bullet_speed_ = speed;
	start_ = start;
...
////////////////////////////////////////////////////////////////////////////////////////////
Action_Bird_Round_Move* Action_Bird_Round_Move::create(const xPoint& center, float radius, float rotate_duration, float start_angle, float rotate_angle, float move_duration, float bird_speed, bool is_centre_bird)
{
	Action_Bird_Round_Move* act = new Action_Bird_Round_Move();
...
bool Action_Bird_Round_Move::init(const xPoint& center, float radius, float rotate_duration, float start_angle, float rotate_angle, float move_duration, float bird_speed, bool is_centre_bird)
{
	center_ = center;
	radius_ = radius;
...
void Action_Bird_Round_Move::update(float time)
{
	_elapsed = time * _duration;
...
xPoint Action_Bird_Round_Move::BirdMoveTo(float elapsed)
{
	///< 到达的时候的时间
	float time = std::min(1.0f, (_elapsed + elapsed) / _duration);
	if (stage_ == 0)
...
////////////////////////////////////////////////////////////////////////////////////////////
Action_Bird_Move_Linear* Action_Bird_Move_Linear::create(float bird_speed, const xPoint& start, const xPoint& end)
{
	Action_Bird_Move_Linear* act = new Action_Bird_Move_Linear();
...
bool Action_Bird_Move_Linear::init(float bird_speed, const xPoint& start, const xPoint& end)
{
	start_ = start;
	end_ = end;
	bird_speed_ = bird_speed;
...
xPoint Action_Bird_Move_Linear::BirdMoveTo(float elapsed)
{
...
//------------------------------------------------------------------------------------------
Action_Bird_Move_Pause_Linear* Action_Bird_Move_Pause_Linear::create(float bird_speed, float pause_time, const xPoint& start, const xPoint& pause, const xPoint& end, float start_angle /* = 0.f */)
{
	Action_Bird_Move_Pause_Linear* act = new Action_Bird_Move_Pause_Linear();
...
bool Action_Bird_Move_Pause_Linear::init(float bird_speed, float pause_time, const xPoint& start, const xPoint& pause, const xPoint& end, float start_angle /* = 0.f */)
{
	start_ = start;
	pause_ = pause;
	end_ = end;
...
xPoint Action_Bird_Move_Pause_Linear::BirdMoveTo(float elapsed)
{
	float time = 0.0;
...
BirdDeathAction* BirdDeathAction::create(float d)
{
	BirdDeathAction *p_action = new BirdDeathAction();
...
bool BirdDeathAction::initWithDuration(float d)
{
	_duration = d;
...
void BirdDeathAction::startWithTarget(Node *target)
{
	CCActionInterval::startWithTarget(target);
}

void BirdDeathAction::update(float time)
{
	///, 现在已经走过的时间
