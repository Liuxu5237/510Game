...
function IntroduceLayer:ctor( scene, url )
    ...
    -- 加载csb资源
    local rootLayer, csbNode = ExternalFun.loadRootCSB("Introduce/IntroduceLayer.csb", self )
...
function IntroduceLayer:createLayer(scene, nKindId, nType)
    ...
    -- 加载csb资源
    local rootLayer, csbNode = ExternalFun.loadRootCSB("Introduce/IntroduceLayer.csb", parent )
